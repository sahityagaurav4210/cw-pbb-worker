...
export class Subscriber {
  ...
  private static async subscribe(): Promise<void> {
    ...
    await this.instance.subscribe(RedisConstants.PROFILE_UPDATE_CHANNEL_NAME);
    await this.instance.subscribe(RedisConstants.SKILL_ADDITION_CHANNEL_NAME);
    await this.instance.subscribe(RedisConstants.SKILL_UPDATE_CHANNEL_NAME);
